...
Так же реализованна InRamDatabase - данные таблиц загружаются в оперативную память и сохранение происходит асинхроно.
----
...
В папке [./server/configs](server/configs) находится файл config.js - в нём задать параметры для подключения к базе данных
```
var configs = {
